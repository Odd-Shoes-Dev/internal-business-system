...
--
-- NOTE: COMMIT / BEGIN markers are intentional — PostgreSQL cannot CREATE
-- INDEX on a table that has pending trigger events from a preceding UPDATE
-- in the same transaction. Each section commits before indexing.
